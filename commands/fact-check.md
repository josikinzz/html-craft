...
- No argument: verify the most recently modified `.html` file in the current
  harness output directory; if no output directory is known, ask for a path
  instead of guessing a legacy global directory.
