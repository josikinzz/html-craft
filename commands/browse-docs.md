...
---
Load the visual-explainer skill, then build a document browser as a single self-contained HTML page for the corpus the user points at.

Follow the visual-explainer skill workflow. Read `../references/browser-patterns.md` before making any structural choice, plus `../references/css-patterns.md` and the skill's Style and Anti-Patterns sections. Follow the impeccable skill's frontend craft (accessibility, responsiveness, deliberate component quality) within this skill's aesthetic constraints.
